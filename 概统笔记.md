...
```readme
1. In this chapter all f_X means the density function of X rather then the partial derivative of f(x) (MENTION THE DIFF BETWEEN UPPER AND LOWER)
...
\\
3. X,Y \sim N(0,1) \longrightarrow X+Y \sim N(0,2)
\\
