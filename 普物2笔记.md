...
>
> $[\epsilon_0] = F \cdot m = C \cdot V^{-1} \cdot m$ 
...
- 有限长带电棒任意点：$\left\{\begin{array}{}	E_x = \frac{\lambda}{4\pi\epsilon_0z}(sin\theta_2-sin\theta_1)\\E_y = \frac{\lambda}{4\pi\epsilon_0z}(cos\theta_1-cos\theta_2)	\end{array}\right.$(大物P17，挺好算的)

  - 有限长带电棒中点：$E = \frac{Q}{4\pi\epsilon_0}\frac{1}{z\sqrt{(\frac L 2)^2+z^2}}$
  - 无限长带电棒：$E=\frac{\lambda}{2\pi\epsilon_0r}$
- 带电圆环：$E=\frac{1}{4\pi\epsilon_0}\frac{\lambda(2\pi R)z}{(R^2+z^2)^\frac{3}{2}}\hat k=\frac{Q}{4\pi\epsilon_0}\frac{z}{(R^2+z^2)^\frac{3}{2}}\hat k$
...
$$
(由平行板电容器推出的普适结论)\\
U=\frac{q^2}{2C}=\frac{q^2d}{2\epsilon A}=\frac{\epsilon}2(\frac q{\epsilon A})^2(Ad)=\frac{\epsilon}2E^2\Omega\\
u=\frac U \Omega
\\
=\frac{\epsilon E^2}2
\\
...
$\oiint \vec D \cdot d \vec A= \Sigma_{i}q_0$(介质中的高斯定理)

==因此计算时可以使用介质中的高斯定理求出D，进而用$\vec D = \kappa_e \epsilon_0 \vec E$求出E==
...
$$
同并联，C=\frac {\epsilon_0 \frac A2}{d}(\kappa_1+\kappa_2)
$$
